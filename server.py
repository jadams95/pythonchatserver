...
SOCK_STREAM means that data or characters are read in a continous flow.
"""
...
def clientthread(conn, addr):
	...
	while True: 
		try: 
			...
			if message: 
				""" prints the message and address of the user who just sent the message of the server terminal"""
	...
	for clients in list_of_clients:
		if clients!=connection:
			try:
				...
				# if the link is broken, we rmeove the client 
				remove(clients)
